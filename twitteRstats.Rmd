---
layout: page
title:  "Tweetstatistics for #rstats"
---
...
bots <- c('Rbloggers', 'RLangTip', 'CRANberriesFeed', 'R_Programming')
```
...
## Most active Users (since `r Sys.Date() - 1`)
...
## Most retweeted users (since `r Sys.Date() - 1`)
...
## Most favourited users (since `r Sys.Date() - 1`)
...
## Most unique users per day (since `r Sys.Date() - 1`)
...
## Number of tweets per day (since `r Sys.Date() - 1`)
